        ...
        function drawLinks() {
            ...
            var appendItem = function(page_id, appendopts){
                ...
                if(page_id == current_page){
                    var lnk = jQuery("<a href='javascript:void(0)' data-id='"+(appendopts.text)+"' class='currentPage'>" + (appendopts.text) + "</a>");
                }else{
                    var lnk = jQuery("<a data-id='"+appendopts.text+"'>"+(appendopts.text)+"</a>")
