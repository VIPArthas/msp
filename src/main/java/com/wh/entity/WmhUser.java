...
public class WmhUser extends BaseModel {
    private String id;
    ...
    private String searchContent;//微门户后台搜索内容

    private String vagueSearch;//微门户模糊查询

    private String tagSearch;//微门户标签查询
	...
	public WmhUser(String id, String realName) {
		super();
		this.id = id;
	...
	WmhUser s=(WmhUser)obj; 
	return id.equals(s.id) && realName.equals(s.realName); 
	}
	@Override
	public int hashCode() {
	String in = id + realName;
	return in.hashCode();
	}
