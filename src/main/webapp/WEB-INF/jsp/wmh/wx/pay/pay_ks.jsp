...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/resource/wmh/wx/commons/css/style.css?v=9"/>
...
<script>
    function zhiFu(orderId, successUrl, failedUrl) {
        ...
        <%--window.location.href = "<%=request.getContextPath()%>/common/userRecharge/wx/cz.htm?successUrl=" + successUrl + "&failedUrl=" + failedUrl + "&rechargeType=3&rechargeMoney=" + 0.01 + "&type=1";--%>
    }
</script>
</body>
</html>